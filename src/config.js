...
module.exports.readConfig = (logger, file = "") => {
  ...
  if (
    !Object.prototype.hasOwnProperty.call(cfg.features, "enable_source_link")
  ) {
  ...
  if (
    !Object.prototype.hasOwnProperty.call(cfg.features, "enable_code_block")
  ) {
  ...
  if (
    !Object.prototype.hasOwnProperty.call(cfg.features, "enable_code_dedenting")
  ) {
